...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/11 10:53:21 by htekdemi          #+#    #+#             */
/*   Updated: 2025/04/11 10:53:21 by htekdemi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (game->total_collectibles < 1 || game->exit_count != 1
		|| game->player_count != 1)
	{
		ft_printf(RED "We have a problem on the map's elements\n" RESET, 0);
